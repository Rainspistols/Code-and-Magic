...
window.GameConstants = {
  Fireball: {
    size: window.globalScope.fireballSize || 24,
    speed:
  ...
  Wizard: {
    speed: window.globalScope.wizardSpeed || 2,
    width: window.globalScope.wizardWidth || 61,
    getHeight:
      window.globalScope.getWizardHeight ||
      function(width) {
        return 1.377 * width;
      },
    getX:
